...
// // type QuizCategory = "intrest" | "skills" | "purpose" | "career" ;
...
// //       "Working outdoors / physical tasks"
// //     ],
// //   },
// //   {
// //     id: 2,
...
// //       "Business & management",
// //       "Arts, design, or creativity",
// //       "Agriculture, nature, field work"
// //     ],
// //   },
// //   {
// //     id: 3,
...
// //       "Reading/intrest new concepts",
// //       "Creating art/design/content",
// //       "Meeting people / social activities",
...
// //       "Computer Science",
// //       "Physical Education / Field activities"
// //     ],
// //   },
// //   {
// //     id: 5,
...
// //     icon: undefined,
// //     options: [
// //       "Working with machines or technology",
// //       "Working with people",
...
// //     icon: undefined,
// //     options: [
// //       "Yes, I like identifying problems",
...
// //     options: [
// //       "Helping people",
// //       "Creating or improving things",
// //       "Earning a stable income",
// //       "Solving challenging problems",
// //       "Doing physical tasks/productive work"
// //     ],
// //   },
// //   {
// //     id: 16,
...
// //   intrest: "bg-blue-500 text-white",
...
// //   intrest: "bg-blue-50/95 border-blue-200 text-blue-900 ring-blue-100",
...
// //     const categories: QuizCategory[] = ["skills", "career", "intrest", "purpose"];
...
// //     const intrest = getResultsSummary.find(r => r.category === 'intrest');
...
// //             We've mapped your responses to find the perfect intersection of your career, style, and skills.
// //           </p>
// //         </motion.div>
...
// //           <MobileCard data={intrest} delay={0.3} />
...
// //                 This short quiz helps us understand your intrest
// //                 purpose, career, and style so we can create a
...
// //                   <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" />
// //                   <span className="text-sm text-gray-700">
// //                     Create a realistic intrest schedule
// //                   </span>
// //                 </div>
// //               </div>
...
// //                 Your answers will help us build the best intrest path
// //                 for your career.
// //               </p>
// //             </div>
// //           </Card>
...
//   career: "bg-blue-50/95 border-blue-200 text-blue-900 ring-blue-100",
...
//                   isSelected
//                     ? "bg-blue-50 border-blue-500 text-blue-800 shadow-sm scale-[1.01]"
//                     : "border-slate-200 bg-white hover:border-blue-200 hover:shadow-sm hover:scale-[1.01] text-slate-700"
//                 }`}
//             >
//               <div className="flex items-start gap-3">
//                 <div className="flex-1">
...
//             onClick={handleFinalSubmit}
//             disabled={isSubmitting}
//             className="rounded-full px-8 py-6 text-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all bg-slate-900 hover:bg-black"
//           >
//             {isSubmitting ? (
//               <>
//                 <Sparkles className="w-5 h-5 mr-2 animate-spin" />
...
//   // ───────────────────── QUIZ VIEW ─────────────────────
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 py-6 px-4 font-sans text-slate-900">
//       {/* Welcome Popup */}
//       {showWelcomePopup && (
//         <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
//           <Card className="max-w-md w-full p-8 shadow-2xl border-0 bg-white">
//             <div className="text-center">
//               <div className="w-16 h-16 bg-blue-100 rounded-2xl rotate-3 flex items-center justify-center mx-auto mb-6">
//                 <Sparkles className="w-8 h-8 text-blue-600 -rotate-3" />
//               </div>
...
//           <div className="w-full h-2 rounded-full bg-slate-200 overflow-hidden">
//             <div
//               className="h-2 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-full transition-all duration-500 ease-out"
//               style={{ width: `${progressPercentage}%` }}
//             />
//           </div>
//         </div>
...
//                 onClick={handleNext}
//                 disabled={!isCurrentQuestionAnswered || isSubmitting}
//                 className="gap-2 pl-6 pr-4 shadow-lg shadow-blue-500/20"
//               >
//                 {currentQuestion === quizQuestions.length - 1
//                   ? "Finish Assessment"
//                   : "Next Question"}
