...
// //   learning: "bg-blue-50 border-blue-200 text-blue-900",
// //   motivation: "bg-purple-50 border-purple-200 text-purple-900",
// //   preferences: "bg-green-50 border-green-200 text-green-900",
// //   goals: "bg-orange-50 border-orange-200 text-orange-900",
// // };
...
// //     } else {
// //       // Instead of submitting immediately, show the results page
// //       setShowResults(true);
// //     }
// //   };
...
// //       // In a real app, this might be a complex weighted calculation
...
// //       // Simple mapping logic for demo purposes based on category
...
// //   if (showResults) {
// //     return (
// //       <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 py-10 px-4 flex items-center justify-center">
...
// //           >
// //             <div className="w-20 h-20 bg-gradient-to-tr from-blue-600 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg text-white">
...
// //               We've analyzed your responses. Here is a breakdown of your learning profile across the four key areas.
// //             </p>
// //           </motion.div>

// //           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
// //             {getResultsSummary.map((result, index) => (
// //               <motion.div
// //                 key={result.category}
// //                 initial={{ opacity: 0, y: 20 }}
// //                 animate={{ opacity: 1, y: 0 }}
...
// //               >
// //                 <Card className={`h-full border-2 overflow-hidden hover:shadow-md transition-all ${categoryBgLight[result.category]}`}>
// //                   <div className="p-6">
// //                     <div className="flex items-center justify-between mb-4">
// //                       <div className={`p-2 rounded-lg shadow-sm ${categoryColors[result.category]}`}>
// //                         {result.icon}
// //                       </div>
...
// //                     <p className="text-sm md:text-base font-medium opacity-90 mb-4 leading-relaxed">
// //                       "{result.answer}"
// //                     </p>
                    
// //                     <div className="pt-4 border-t border-black/5 flex items-center gap-2 text-xs font-semibold uppercase tracking-wide opacity-60">
...
// //               className="px-10 py-6 text-lg bg-gray-900 hover:bg-black text-white shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1"
// //             >
// //               {isSubmitting ? (
// //                 <>
...
const QuizPage = () => {
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center py-8 px-4 relative overflow-x-hidden">
        {/* Background ambient light */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-blue-100 rounded-full blur-3xl opacity-40 mix-blend-multiply" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] bg-purple-100 rounded-full blur-3xl opacity-40 mix-blend-multiply" />
          <div className="absolute top-[40%] left-[40%] w-[30vw] h-[30vw] bg-pink-100 rounded-full blur-3xl opacity-40 mix-blend-multiply" />
        </div>
